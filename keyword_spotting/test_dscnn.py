...
if __name__ == "__main__":
    ...
    # print('=====================================')
    # plot_benefit_curve_ev_effectiveness(Config.model_name_ev, Config.model_name_noev, Config.Config.model_name_eefmaps_concat, total_sample=Config.total_samples)
    # print('DONE!\n\n')
    ...
    print('===============================================================\n')
    helpers.generate_trace(ds_test, Config.model_name_ev)
    helpers.generate_trace_sdn(ds_test, Config.model_name_sdn)
    helpers.generate_trace_branchynet(ds_test, Config.model_name_branchynet)
    print('DONE!')
    #plot the benefit curve
    print('=====================================')
